...
export const Hero = [
  ...
  },
  {
    ...
    texts: [
      ...
      "У школі активно займався кількома видами спорту гирьовим, боксом, класичною боротьбою. ",
      "Мав грамоти, почесні відзнаки не тільки зі спорту, а й за високу дисципліну,глибоке володіння початковою воєнною підготовкою та активну громадську діяльність. ",
      "1986 – 1988 р.р. – строкова військова служба в РадянськійАрмії. Мав звання старший сержант.",
      "У 1994 році закінчив Запорізький машино-будівний інститут, факультет автомобіле - і тракторобудування. ",
      "У 1997 році з родиною приїхав до селища Балабине на постійне місце проживання. ",
      "Працював в Державному підприємстві ,,Запорізьке машинобудівне конструкторське  бюро ,,Прогрес’’ імені академіка О.Г.Івченка’’ в  лабораторії авіа-двигунів при інженерному складі.",
      "Неодноразово заохочувався за сумлінну працю керівництвом підприємства, нагороджений медаллю . ",
      "Займався самоосвітою та самовдосконаленням. Підтримував Народний Рух України В.Чорновіла, бувактивістом, справжнім патріотом України, людиною високих моральних принципів.",
      "Був активним учасником Євромайдану.",
      "З серпня 2014 року приймав участь в Антитерористичній операції на території Донецької та Луганської областей з метою виконання службових(бойових) завдань рядовим, стрільцем відділення охорони взводу, охорони роти, охорони в складі 42 батальйону територіальної оборони(військова частина – польова пошта  В4750  м.Кіровоград) . ",
      "23 листопада 2014року тяжко поранений, 24 листопада – помер. ",
      "Був одружений, дружина Стасюк Ольга Володимирівна,23.05.1966р.н. ",
      "Виховував двох доньок  Катерину, 17.08.1994 р.н. та Анну, 02.04.2000 р.н. ",
      "Указом Президента України № 311/2015 від 4 червня 2015 року, -за особисту мужність і високий професіоналізм, виявлені у захисті державного суверенітету та територіальної цілісності України, вірність військовій присязі-, нагороджений орденом «За мужність» IIIступеня (посмертно). ",
    ],
  },
  {
    id: 30,
